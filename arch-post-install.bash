...
install_gnome()
{
	...
	read -e -p "Enter GNOME packages to ignore: " -i "cheese,epiphany,gedit,gnome-books,gnome-boxes,gnome-calendar,gnome-characters,gnome-clocks,gnome-contacts,gnome-logs,gnome-maps,gnome-music,gnome-photos,gnome-software,gnome-video-effects,malcontent,orca,rygel,totem,tracker,tracker-miners,vino" gnome_ignore
	echo ""
