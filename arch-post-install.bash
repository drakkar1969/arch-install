...
install_gnome()
{
	...
	read -e -p "Enter GNOME packages to ignore: " -i "decibels,epiphany,gnome-calendar,gnome-characters,gnome-clocks,gnome-connections,gnome-contacts,gnome-logs,gnome-maps,gnome-music,gnome-software,gnome-system-monitor,gnome-tour,orca" gnome_ignore
	echo
