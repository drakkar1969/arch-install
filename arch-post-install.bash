...
install_gnome()
{
	...
	read -e -p "Enter GNOME packages to ignore: " -i "cheese,epiphany,gnome-calendar,gnome-characters,gnome-clocks,gnome-contacts,gnome-logs,gnome-maps,gnome-music,gnome-photos,gnome-software,gnome-tour,gnome-video-effects,orca,rygel,totem" gnome_ignore
	echo ""
