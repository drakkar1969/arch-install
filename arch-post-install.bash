...
install_gnome()
{
	...
	read -e -p "Enter GNOME packages to ignore: " -i "epiphany,gnome-books,gnome-boxes,gnome-calendar,gnome-characters,gnome-clocks,gnome-contacts,gnome-documents,gnome-maps,gnome-music,gnome-photos,gnome-software,orca,totem" gnome_ignore
	echo ""
