...
```bash
pacman -S networkmanager gnome --ignore cheese,epiphany,gnome-books,gnome-boxes,gnome-calendar,gnome-characters,gnome-clocks,gnome-contacts,gnome-maps,gnome-music,gnome-photos,gnome-software,gnome-video-effects,orca,rygel,totem,vino
```
