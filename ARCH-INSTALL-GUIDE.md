...
```bash
pacman -S networkmanager gnome --ignore decibels,epiphany,gnome-calendar,gnome-characters,gnome-clocks,gnome-connections,gnome-contacts,gnome-logs,gnome-maps,gnome-music,gnome-software,gnome-system-monitor,gnome-tour,orca
```
