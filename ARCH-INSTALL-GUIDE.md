...
```bash
pacman -S networkmanager gnome --ignore cheese,epiphany,gedit,gnome-books,gnome-boxes,gnome-calendar,gnome-characters,gnome-clocks,gnome-contacts,gnome-logs,gnome-maps,gnome-music,gnome-photos,gnome-software,gnome-video-effects,malcontent,orca,rygel,totem,tracker,tracker-miners,vino
```
